...
const PLATFORM_INTRO: Record<string, string> = {
  ...
  weixin:
    "Run `reuben gateway setup`, select Weixin, then scan and confirm the QR code with a personal WeChat account. Reuben connects through Tencent's iLink Bot API and saves the credentials.",
