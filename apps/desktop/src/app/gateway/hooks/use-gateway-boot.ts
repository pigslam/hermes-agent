...
export function useGatewayBoot({
  ...
  useEffect(() => {
    ...
    // composer stayed disabled forever on "Starting Reuben...". Once the
    ...
    const attemptReconnect = async () => {
      ...
      try {
        ...
        // "Starting Reuben…". The probe is a no-op for a healthy or local backend.
        ...
        // as an opaque "Could not connect to Reuben gateway". resolveGatewayWsUrl
