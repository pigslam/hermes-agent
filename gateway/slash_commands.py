...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_version_command(self, event: MessageEvent) -> str:
        """Handle /version — show the running Reuben Agent version."""
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        """Handle /update command — update Reuben Agent to the latest version.
        ...
        if is_managed():
            return f"✗ {format_managed_message('update Reuben Agent')}"
