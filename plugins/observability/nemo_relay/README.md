...
not replace Reuben Agent's planner, tools, memory, model provider routing, or
...
With this plugin enabled, Reuben Agent can:
...
export HERMES_NEMO_RELAY_ATIF_AGENT_NAME='Reuben Agent E2E'
...
```json
{
  ...
  "session_id": "docs-parent-session",
  "agent": {"name": "Reuben Agent E2E", "version": "docs-example", "model_name": "qwen3.6:35b"},
  "steps": [
    {
      "source": "agent",
