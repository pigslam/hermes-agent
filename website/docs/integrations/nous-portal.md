...
sidebar_position: 1
title: "Nous Portal"
description: "One subscription, 300+ frontier models, the Tool Gateway, and Nous Chat — the recommended way to run Reuben Agent"
---
...
The same subscription unlocks the [Tool Gateway](/user-guide/features/tool-gateway), which routes Reuben Agent's tool calls through Nous-managed infrastructure. Five backends, one login:
