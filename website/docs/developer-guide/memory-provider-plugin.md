...
description: "How to build a memory provider plugin for Reuben Agent"
---

# Building a Memory Provider Plugin

Memory provider plugins give Reuben Agent persistent, cross-session knowledge beyond the built-in MEMORY.md and USER.md. This guide covers how to build one.
