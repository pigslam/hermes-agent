...
description: "Use Reuben Agent inside ACP-compatible editors such as VS Code, Zed, and JetBrains"
---

# ACP Editor Integration

Reuben Agent can run as an ACP server, letting ACP-compatible editors talk to Hermes over stdio and render:
...
2. Select **Reuben Agent** from the built-in agent list.
...
- In Zed, open the ACP Registry with `zed: acp registry` and search for **Reuben Agent**.
...
Install `uv` from the official uv installation docs, then retry the Reuben Agent thread from Zed.
