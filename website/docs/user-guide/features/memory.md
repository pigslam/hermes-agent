...
description: "How Reuben Agent remembers across sessions — MEMORY.md, USER.md, and session search"
---

# Persistent Memory

Reuben Agent has bounded, curated memory that persists across sessions. This lets it remember your preferences, your projects, your environment, and things it has learned.
