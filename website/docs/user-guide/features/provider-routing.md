...
When using [OpenRouter](https://openrouter.ai) as your LLM provider, Reuben Agent supports **provider routing** — fine-grained control over which underlying AI providers handle your requests and how they're prioritized.
