...
sidebar_position: 5
title: "WhatsApp"
description: "Set up Reuben Agent as a WhatsApp bot via the built-in Baileys bridge"
---
...
- Agent responses are prefixed with "⚕ **Reuben Agent**" by default. You can customize or disable this in `config.yaml`:
