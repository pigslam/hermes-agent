---
title: "Openclaw Migration — Migrate a user's OpenClaw customization footprint into Reuben Agent"
sidebar_label: "Openclaw Migration"
description: "Migrate a user's OpenClaw customization footprint into Reuben Agent"
---
...
Migrate a user's OpenClaw customization footprint into Reuben Agent. Imports Hermes-compatible memories, SOUL.md, command allowlists, user skills, and selected workspace assets from ~/.openclaw, then reports exactly what could not be migrated and why.
...
| Version | `1.0.0` |
| Author | Reuben Agent (Nous Research) |
| License | MIT |
...
Use this skill when a user wants to move their OpenClaw setup into Reuben Agent with minimal manual cleanup.
