...
| Version | `1.0.1` |
| Author | Joe Rinaldi Johnson (joerj123), Reuben Agent |
| License | MIT |
...
| Telegram (Reuben Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
