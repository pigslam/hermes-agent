...
description: "Modify, debug, or extend the s6-overlay supervision tree inside the Reuben Agent Docker image — adding new services, debugging profile gateways, understandin..."
---
...
Modify, debug, or extend the s6-overlay supervision tree inside the Reuben Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern.
...
If you're just running the Reuben Agent and want to use Docker, see `website/docs/user-guide/docker.md` instead.
