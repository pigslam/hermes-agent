...
description: "Catalog of bundled skills that ship with Reuben Agent"
---
...
| [`hermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) | Configure, extend, or contribute to Reuben Agent. | `autonomous-ai-agents/hermes-agent` |
