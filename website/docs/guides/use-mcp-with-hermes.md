...
description: "A practical guide to connecting MCP servers to Reuben Agent, filtering their tools, and using them safely in real workflows"
---

# Use MCP with Hermes

This guide shows how to actually use MCP with Reuben Agent in day-to-day workflows.
