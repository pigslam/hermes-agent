...
This tutorial walks you through setting up a Telegram bot powered by Reuben Agent that multiple team members can use. By the end, your team will have a shared AI assistant they can message for help with code, research, system administration, and anything else — secured with per-user authorization.
...
- **Reuben Agent installed** on a server or VPS (not your laptop — the bot needs to stay running). Follow the [installation guide](/getting-started/installation) if you haven't yet.
...
4. **Set a description** (optional but recommended):
   ...
   ```
   Team AI assistant powered by Reuben Agent. DM me for help with code, research, debugging, and more.
   ```
