...
description: "Run Reuben Agent directly on an Android phone with Termux"
---
...
Reuben Agent can run directly on an Android phone through [Termux](https://termux.dev/).
