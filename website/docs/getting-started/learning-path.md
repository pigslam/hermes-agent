...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Reuben Agent documentation based on your experience level and goals.'
---

# Learning Path

Reuben Agent can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Reuben Agent yet, begin with the [Installation guide](/getting-started/installation) and then run through the [Quickstart](/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Reuben Agent can do.
...
Use Reuben Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Reuben Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Reuben Agent as a bot on your favorite messaging platform.
...
:::tip
Cron jobs let Reuben Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Reuben Agent with your own tools and reusable skill packages.
...
Use reinforcement learning to fine-tune model behavior with Reuben Agent's RL training pipeline (powered by [Atropos](https://github.com/NousResearch/atropos)).
...
:::tip
RL training works best when you already understand the basics of how Reuben Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Reuben Agent into your own Python applications programmatically.
