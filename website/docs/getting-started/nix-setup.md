...
description: "Install and deploy Reuben Agent with Nix — from quick `nix run` to fully declarative NixOS module with container mode"
---
...
Reuben Agent ships a Nix flake & a NixOS module.
