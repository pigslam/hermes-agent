...
# Bootstrap Open WebUI against Reuben Agent's OpenAI-compatible API server.
#
...
#   HERMES_API_MODEL_NAME='Reuben Agent'

OPEN_WEBUI_PORT="${OPEN_WEBUI_PORT:-8080}"
OPEN_WEBUI_HOST="${OPEN_WEBUI_HOST:-127.0.0.1}"
OPEN_WEBUI_NAME="${OPEN_WEBUI_NAME:-Reuben Agent WebUI}"
...
HERMES_API_MODEL_NAME="${HERMES_API_MODEL_NAME:-Reuben Agent}"
...
install_systemd_user_service() {
  ...
  cat > "$unit" <<EOF
[Unit]
Description=Open WebUI connected to Reuben Agent
