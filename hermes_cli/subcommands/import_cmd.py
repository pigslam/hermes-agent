...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a Reuben backup from a zip file",
        description="Extract a previously created Reuben backup into your "
        "Reuben home directory, restoring configuration, skills, "
        "sessions, and data",
    )
