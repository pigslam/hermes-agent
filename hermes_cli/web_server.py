...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",       "label": "Reuben Blue",         "description": "Cool blue and graphite — the canonical Reuben look"},
    {"name": "default-large", "label": "Reuben Blue (Large)", "description": "Reuben Blue with bigger fonts and roomier spacing"},
