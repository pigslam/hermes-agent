...
Usage:
    reuben pairing list              # Show all pending + approved users
    reuben pairing approve <platform> <code>  # Approve a pairing code
    reuben pairing revoke <platform> <user_id> # Revoke user access
    reuben pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle reuben pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: reuben pairing {list|approve|revoke|clear-pending}")
        print("Run 'reuben pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'reuben pairing list' to see pending codes.\n")
