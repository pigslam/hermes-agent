...
Used by ``reuben profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Reuben Agent kanban board.
...
Rules:
  ...
  - Never write "Reuben Agent profile" or other meta-narration.
