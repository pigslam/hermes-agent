...
# `reuben tools` picker scope its entitlement gate to the selected backend, so a
...
def get_nous_subscription_features(
    ...
    *,
    ...
    # Tool Gateway via `reuben model`, so direct credentials should NOT
...
# ---------------------------------------------------------------------------
# Inline Nous Portal login for the Tool Gateway picker (`reuben tools`)
# ---------------------------------------------------------------------------
...
def ensure_nous_portal_access(
    *,
    ...
    Used by ``reuben tools`` when a user selects a Nous-managed Tool Gateway
    backend (e.g. "Firecrawl (Nous Portal)").  Unlike ``reuben model``'s Nous
    login, this:
